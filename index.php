...
function jy(){
	...
	timeElement.innerHTML = "<p>这套系统的开发目的是快捷聊天!<br>其实刚写这个的时候我的目的很单一，就是和朋友在课上聊聊天。因为我们那边的电脑每次重启都会重置，所以才搞的这个。<br>这个源码本身也是疫情的时候上网课的时候无聊写的，代码也是看我和我朋友的需求写的，有不足之处，需要的自己改吧。<br>现在所有娱乐课程都没了，也没多少时间写代码了。<br>每个版本我都在葫芦侠和b站更新了，需要自提。<br></p>";	
}
</script>
...
echo 'http://www.adouzi56.ml/homework/branch/img/index.php';
}else{
echo $_COOKIE['背景图片'];
}
?>');
